...
data_obj = ImagenetObjectCrop_noniid(dataset='Imagenet200', data_path=data_path, n_client=n_client, rule='hetero', unbalanced_sgm=0, rule_arg=0.3,split_ratio=0.7,batch_size=batch_size,test_client_number=0,test_recon_ratio=0.7*0.5)
n_cls = 200
###
model_name        = 'Resnet18_200'
com_amount         = 1000
save_period        = 50
weight_decay       = 1e-4
act_prob           = 1
