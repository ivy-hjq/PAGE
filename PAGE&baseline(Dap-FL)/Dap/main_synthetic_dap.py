...
if __name__ == "__main__":
    ...
    parser.add_argument('--env', default='Dap_synthetic-v0', type=str, help='open-ai gym environment, PAGE-v1 shakespear, PAGE-v2 synthetic')
    ...
    parser.add_argument('--output', default='Output/Dap/synthetic', type=str, help='')
