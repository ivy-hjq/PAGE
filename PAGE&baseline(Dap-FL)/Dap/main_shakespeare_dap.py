    ...
    while step < num_iterations:
        ...
        if observation is None:
            ...
            for i in range(len(observation)):
                observation[i]=[observation[i],3.0]
...
if __name__ == "__main__":
    ...
    parser.add_argument('--env', default='Dap_shakespeare-v0', type=str, help='open-ai gym environment, PAGE-v1 shakespear, PAGE-v2 synthetic')
    ...
    parser.add_argument('--output', default='Output/Dap/shakespeare', type=str, help='')
    ...
    s_agent=DDPG(s_nb_states,s_nb_actions,s_nb_agents,args,hidden1=args.hidden1,hidden2=args.hidden2,bsize=args.bsize,lr_max=args.lr_max, lr_min=args.lr_min, epoch_max=args.epoch_max)
