...
if __name__ == "__main__":
    ...
    parser.add_argument('--env', default='Dap_imagenet200-v0', type=str, help='open-ai gym environment, PAGE-v1 shakespear, PAGE-v2 synthetic')
    ...
    parser.add_argument('--output', default='Output/Dap/tiny-imagent-200', type=str, help='')
    ...
    print(env.observation_space.shape)#(6,)
    print(env.action_space.shape)#(2,)
