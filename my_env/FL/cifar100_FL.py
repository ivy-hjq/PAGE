...
class FL_cifar100():
    def __init__(self,path,data_path,device):
        ...
        data_path=data_path
        self.path=path
        self.data_obj = ImagenetObjectCrop_noniid(dataset='CIFAR100', data_path=data_path, n_client=n_clnt, rule='hetero', unbalanced_sgm=0, rule_arg=0.3,split_ratio=0.7,batch_size=self.batch_size)
        self.penalty=0
        ###
