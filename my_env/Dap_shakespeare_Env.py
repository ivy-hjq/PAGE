...
from gym.envs.my_env.FL.shakespeare_FL import *

class Dap_shakespeare_Env(gym.Env):
    """
    ### Description
    ...
    def __init__(self,output,data_path,device):
        ...
        self.max_state=np.array([100.0,100.0])
        ...
        self.FL=FL_shakespeare(output,data_path,device)
